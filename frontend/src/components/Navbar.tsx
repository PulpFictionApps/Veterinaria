    ...
    <>
      ...
      >
        ...
        <aside
          ...
          role="dialog"
          aria-modal="true"
          className={`absolute left-0 top-0 h-full w-72 max-w-full bg-white border-r border-gray-200 p-4 transform transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : '-translate-x-full'}`}
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold">Veterinaria</h3>
            </div>
